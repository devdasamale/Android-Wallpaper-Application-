...
import com.devdas.wallpaper_161123.activity.PreviewActivity;
...
public class WallpaperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void loadInterstitialAd() {
        ...
        InterstitialAd.load(ctx, ctx.getString(R.string.Interstitial), adRequest, new InterstitialAdLoadCallback() {
            @Override
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        Picasso.get().load(wallpaperList.get(position)).placeholder(R.mipmap.ic_launcher_square).fit().into(wallpaperView.image);
    ...
    private class WallpaperView extends RecyclerView.ViewHolder{
